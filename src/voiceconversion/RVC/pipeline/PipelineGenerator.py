...
def createPipeline(model_dir: str, modelSlot: RVCModelSlot, f0Detector: str, useONNX: bool, force_reload: bool, pretrain_dir: str):
    # Inferencer 生成
    if useONNX:
    ...
    # Embedder 生成
    embedder = EmbedderManager.get_embedder(pretrain_dir, modelSlot.embedder, force_reload)
